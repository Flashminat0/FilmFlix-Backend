...
<!-- mov-upload -->
<div class="bloc l-bloc animated puffIn bloc-bg-texture texture-fabric" id="mov-upload" data-appear-anim-style="puffIn">
				...
				<div class="row">
					<div class="col">
						<div class="upload-form">
							<button class="btn btn-d btn-lg bloc-button float-lg-none btn-select-file-style animated vanishIn animDelay06" type="submit" id="mov-upload-select-file-btn" data-appear-anim-style="vanishIn">
		...
		<div class="row">
			<div class="col-md-3 col-sm-6">
				<h4 class="mg-md text-sm-left text-center">
					About
				</h4><a href="about.jsp" class="a-btn a-block footer-link">The Team</a><a href="about.jsp" class="a-btn a-block footer-link">Contact Us</a>
			</div>
			<div class="col-md-3 col-sm-6">
				<h4 class="mg-md text-sm-left text-center">
					Get the app
				</h4><a href="get-the-app.jsp" class="a-btn a-block footer-link">Android</a><a href="get-the-app.jsp" class="a-btn a-block footer-link">iOS</a>
			</div>
			<div class="col-md-3 col-sm-6">
				<h4 class="mg-md text-sm-left text-center">
					Follow Us
